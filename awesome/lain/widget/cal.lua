...
local function factory(args)
    ...
    local cal = {
        ...
        icons               = args.icons or helpers.icons_dir .. "cal/nord/",
        screen              = args.screen,
        notification_preset = args.notification_preset or {
            font = "Ubuntu Monospace 10", fg = "#FFFFFF", bg = "#000000"
        }
    }
    ...
    function cal.show(seconds, month, year, scr)
        ...
        cal.notification = naughty.notify {
            preset  = cal.notification_preset, --tag       = mouse.screen.selected_tag,
            screen  = awful.screen.focused("mouse") or scr or 1,
            icon    = cal.icon,
